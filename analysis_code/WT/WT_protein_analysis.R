...
flowData <- read.flowSet( files = list.files( pattern = "_[CEF]0[1345678].*fcs" ), transformation = F)
...
if(plots_on == TRUE) {
   ...
   png("fluor-ungated.png", width = 20, height = 10, units = "in", res = 300 )
