...
qpcr1 <- read.csv(paste0(datadir, "codopt_Ingolia Lab_2017-09-13 10-16-37_CT009900_sample-info.csv"), header = T)
qpcr1.cq <- read.csv(paste0(datadir, "codopt_Ingolia Lab_2017-09-13 10-16-37_CT009900 -  Quantification Summary_0.csv"), header = T)

qpcr2 <- read.csv(paste0(datadir, "codopt_MIN069_Ingolia Lab_2017-10-24 14-15-53_CT009900_sample-info.csv"), header = T)
qpcr2.cq <- read.csv(paste0(datadir, "codopt_MIN069_Ingolia Lab_2017-10-24 14-15-53_CT009900 -  Quantification Summary_0.csv"), header = T)

qpcr3 <- read.csv(paste0(datadir, "codopt_MIN6_redux_Ingolia Lab_2017-11-01 11-34-53_CT009900_sample-info.csv"), header = T)
qpcr3.cq <- read.csv(paste0(datadir, "codopt_MIN6_redux_Ingolia Lab_2017-11-01 11-34-53_CT009900 -  Quantification Summary_0.csv"), header = T)
...
write.csv(ratios, paste0( datadir, "WT_mRNA_ratios.csv" ), row.names=FALSE)
