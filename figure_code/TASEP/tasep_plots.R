...
abline(h=0.65, lwd=0.8, col='#808285', lty = 2)
abline(h=0.32, lwd=0.8, col='#4e4e4e', lty = 2)

text(x = 6.25, y = 0.65, adj = c(1, -0.2), labels="ratio expected from\nmRNA abundance alone", col='#808285', cex = 0.7)
text(x = 6.25, y = 0.32, adj = c(1, 1.3), labels="observed ratio", col='#4e4e4e', cex = 0.7)
dev.off()
