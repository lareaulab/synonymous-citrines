...
WT_mRNA_ratios <- read.csv( paste0( datadir, "WT_mRNA_ratios.csv" ))
...
pdf( paste0( figdir, "tunney_citrine_mrna.pdf" ), width = 1.75, height = 1.3, pointsize = 6.5, useDingbats = F, bg = "white" )
